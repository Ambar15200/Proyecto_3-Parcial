...
namespace examenTercerP
{
    internal class Program
    {
        ...
        static void Main()
        {
            //EL BUCLE WHILE PERMITE QUE EL PROGRAMA CONTINUE EJECUTANDOSE   
    ...
    static int[,] RestarMatrices(int[,] m1, int[,] m2)
        ...
        //DE QUE EL NÚMERO DE COLUMNAS DE LA 1° MATRIZ DEBE COINCIDIR CON EL NÚMERO DE FILAS EN LA SEGUNDA
